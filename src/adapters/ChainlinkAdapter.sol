...
import "core/base/VaultControllerStrategyUpgrade.sol";

ERC20 constant LINK = ERC20(0x514910771AF9Ca656af840dff83E8264EcF986CA);
IStaking constant stakeController = IStaking(0x3feB1e09b4bb0E7f0387CeE092a52e85797ab889);
...
contract ChainlinkAdapter is Adapter, VaultControllerStrategyUpgrade {
    ...
    function initialize(
        ...
        initializer
    {
        __VaultControllerStrategy_init(_token, _stakingPool, _stakeController, _vaultImplementation, _minDepositThreshold, _fees);
    ...
    function addVault(address _operator) public {
        bytes memory data = abi.encodeWithSignature(
            "initialize(address,address,address,address)", address(token), address(this), address(stakeController), _operator
        );
        _deployVault(data);
