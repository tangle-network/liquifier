...
contract ERC677Upgradeable is ERC20Upgradeable {
    function __ERC677_init(string memory _tokenName, string memory _tokenSymbol, uint256 _totalSupply) public onlyInitializing {
    ...
    function transferAndCallFrom(address _sender, address _to, uint256 _value, bytes memory _data) internal returns (bool) {
